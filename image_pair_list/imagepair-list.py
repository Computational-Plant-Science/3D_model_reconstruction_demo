...
python imagepair-list.py -p /home/suxingliu/20180213_3240/20180213_3240_cropped/ -nrow 360 -ncol 10 -intervalrow 90 -intervalcol 9 -s /home/suxingliu/pairlist_360_10/

python imagepair-list.py -p /home/suxingliu/Test/ -nrow 4 -ncol 3 -intervalrow 4 -intervalcol 2 
...
if __name__ == '__main__':
    ...
    if (args["savepath"] == None):
        ...
        save_path = current_path + 'PairList_' + str(args["pairinterval_row"]) + '_' + str(args["pairinterval_col"]) + '_' + '.txt'
        save_path_full = current_path + 'PairList_full.txt'
    else: 
            
        save_path = args["savepath"] + 'PairList_' + str(args["pairinterval_row"]) + '_' + str(args["pairinterval_col"]) + '_' + '.txt'
